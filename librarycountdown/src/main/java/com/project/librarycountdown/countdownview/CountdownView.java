...
public class CountdownView extends View {
    ...
    public void start(long millisecond) {
        ...
        mCustomCountDownTimer = new CustomCountDownTimer(millisecond, countDownInterval) {
            @Override
            public void onTick(long millisUntilFinished, boolean isAlready) {
    ...
    public void setNeedLayout(boolean isNeed) {
        isNeedLayout = isNeed;
    }
    ...
    public void setTimeTextTypefaceIndex(int typefaceIndex) {
        mCountdown.setTimeTextTypefaceIndex(typefaceIndex);
        invalidate();
        requestLayout();
    }

    public Integer getTimeTextTypefaceIndex() {
        return mCountdown.getTimeTextTypefaceIndex();
    }
