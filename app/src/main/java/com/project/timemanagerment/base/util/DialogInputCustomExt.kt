...
@CheckResult
fun MaterialDialog.inputNoAutoKeyboard(
    hint: String? = null,
    ...
    if (callback != null && waitForPositiveButton) {
        ...
        positiveButton { callback.invoke(this@inputNoAutoKeyboard, getInputField().text ?: "") }
    }
...
private fun MaterialDialog.styleInput(
    ...
    val att = R.attr.md_color_button_text
    val att1 = R.attr.md_color_hint
