 ...
 */
package com.project.librarycalendarview.calendarview;
...
import com.project.librarycalendarview.R;
...
public class CalendarView extends FrameLayout {
    ...
    public void setStartAndEndDate(Date startDate, Date endDate) {
        mDelegate.setStartDate(startDate);
        mDelegate.setEndDate(endDate);
        update();
    }
}
